    ...
    return (
        <section className="bg-[#0b0e13] pb-20">
            <div className="container mx-auto px-4 md:px-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 min-h-[500px] rounded-3xl overflow-hidden">

                    {/* Col 1: Dark Tech Card */}
                    <div className="bg-[#11141b] p-8 md:p-10 flex flex-col justify-between border-r border-b border-white/5 relative group">
                        <div className="mb-6">
                            <div className="w-14 h-14 border border-white/10 rounded-xl flex items-center justify-center mb-6 text-[#AEE2FF]">
                    ...
                    <div className="bg-[#0b0e13] p-8 md:p-10 flex flex-col justify-center border-r border-b border-white/5 relative">
                        <div className="flex items-center -space-x-4 mb-8">
                            ...
                            <div className="w-12 h-12 rounded-full border-2 border-[#0b0e13] bg-[#AEE2FF] flex items-center justify-center text-black font-bold text-xs">
                                1k+
                            </div>
                        </div>
                    ...
                    {/* Col 3: Image Card */}
                    <div className="relative h-[300px] md:h-auto border-r border-b border-white/5">
                        <Image
                    ...
                    <div className="bg-[#11141b] p-8 md:p-10 flex flex-col justify-between border-b border-white/5 relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                            <button className="bg-[#AEE2FF] hover:bg-[#90d5ff] text-black px-6 py-3 rounded-md font-bold text-sm w-full top-3 flex items-center justify-between group">
                                Contact Us
                        ...
                        <div className="absolute bottom-0 right-[-20px] w-64 h-64 z-0 pointer-events-none opacity-80">
