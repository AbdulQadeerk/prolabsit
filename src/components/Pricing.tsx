                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
                    {plans.map((plan, index) => (
                        <Reveal key={index} direction="up" delay={index * 0.1}>
                            <div className="bg-[#11141b] rounded-md p-8 border border-white/5 hover:border-white/10 transition-colors h-full flex flex-col group">
                                ...
                                {/* Button */}
                                <button className="w-full bg-[#AEE2FF] hover:bg-[#90d5ff] text-[#0b0e13] py-4 rounded-[4px] font-bold text-sm transition-transform active:scale-95">
                                    Get Started Now
                                </button>
